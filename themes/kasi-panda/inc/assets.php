...
function kasi_panda_scripts() {
	...
	wp_enqueue_script( 'kasi-panda-kasi-panda', get_template_directory_uri() . '/js/kasi-panda.js', array(), '20170804', true );
...
function my_theme_wrapper_start() {
    echo '<section id="main" class="uk-container uk-margin-top">';
}
